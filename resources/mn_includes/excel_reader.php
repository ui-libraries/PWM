<?php
/**
 * A  for reading Microsoft Excel (97/2003) Spreadsheets.
 *
 * Version 2.21
 *
...
class Spreadsheet_Excel_Reader {
	...
	function _format_value($format,$num,$f) {
		...
		//split has been deprecated, replace with explode
		//$parts = split(";",$format);
...
//note following line causes an error:
//Assigning the return value of new by reference is deprecated
//solution to remove "&" found here: http://code.google.com/p/php-excel-reader/issues/detail?id=89
